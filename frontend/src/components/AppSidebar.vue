  ...
  >
    ...
    <nav class="flex-1 overflow-y-auto px-2 py-3 space-y-4">
      ...
      <section>
        ...
        <NavItem to="/productos"       :icon="IconBox"    label="Productos"        :activeRoutes="['ProductoList', 'ProductoDetail']" />
        <NavItem to="/productos/nuevo" :icon="IconPlus"   label="Nuevo Producto"   :activeRoutes="['ProductoNuevo']" />
        <NavItem to="/precios"         :icon="IconTag"    label="Reglas de Precio" :activeRoutes="['Precios']" />
      </section>
      ...
      <!-- Ventas: recordatorios de vigencia de precio acordado (link a ERPNext) -->
      <section>
        <p class="nav-section-label">Ventas</p>
        <ExternalNavItem href="/app/precio-acordado-recordatorio" :icon="IconBell" label="Recordatorios de Precio"/>
      </section>
...
const IconPlus     = svgIcon("M12 4v16m8-8H4");
...
const IconBox      = svgIcon("M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10");
const IconTag      = svgIcon("M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z");
